...
- (void)adjustIndicatorFrame
{
    ...
    [self.toastView setFrame:CGRectMake((kFTScreenWidth - toastSize.width)/2, (kFTScreenHeight - [self keyboardHeight] - toastSize.height) / 2, toastSize.width, toastSize.height)];
